...
post=json.load(open('phase_eval_direct_phase3_post_p3_1775596266.json',encoding='utf-8'))
...
post_g=json.load(open('phase_eval_direct_global_post_p3_1775596294.json',encoding='utf-8'))
