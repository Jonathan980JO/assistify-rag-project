...
2. Verify Python executable exists: `conda activate assistify_main` then `python --version`
3. Check project root has `backend/` and `Login_system/` folders
4. Run with explicit conda python: `conda run -n assistify_main python start_main_servers.py`
