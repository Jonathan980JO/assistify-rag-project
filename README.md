...
│   └── screenshots/         # banner.png, architecture.png, features.png
...
![Assistify feature overview](assets/screenshots/features.png)
...
![Assistify system architecture](assets/screenshots/architecture.png)
...
# 5. Open http://127.0.0.1:7001/login
#    Bootstrap login — Username: superadmin  Password: superadmin
```
...
| Banner | Architecture | Features |
|--------|--------------|----------|
| ![Assistify banner](assets/screenshots/banner.png) | ![System architecture](assets/screenshots/architecture.png) | ![Feature overview](assets/screenshots/features.png) |
